...
@Component({
  ...
  templateUrl: './mysql-lazy-table.component.html',
  styleUrl: './mysql-lazy-table.component.scss'
})
export class MysqlLazyTableComponent {
  ...
  ngOnInit() {
    this.loading = true;
    this.customerService.getMysqlCustomers().subscribe(res => {
      this.customersList.customers = res.customers;
      this.customersList.totalRecords = res.totalRecords;
      this.loading = false;
    });

    this.representativeService.getMysqlRepresentatives().subscribe(res => {
  ...
  lazyLoad($event: TableLazyLoadEvent) {
    this.loading = true
    this.customerService.getMysqlCustomers({
